...
int SearchStrategy::evaluate(Board& board)
{
...
void SearchStrategy::generateMoves(MoveList& list, Board& board)
{
...
void SearchStrategy::playMove(const Move& m, Board& board)
{
    board.playMove(m);
}
...
bool SearchStrategy::takeBack(Board& board)
{
    return board.takeBack();
}
